...
bot_btn1 = button.Button('Bot ON', 100, 50, (290, 510), 1, screen, font)
bot_btn2 = button.Button('Bot OFF', 100, 50, (290, 570), 1, screen, font)
        ...
        for i in range(4):
            for j in range(5):
                ...
                if shift > 0:
                    ...
                    board[3 - i][j] = 0
                if 4 - i + shift <= 4:
                    if board[3 - i + shift][j] == board[4 - i + shift][j] and not merged[4 - i + shift][j] and not merged[3 - i + shift][j]:
                        board[4 - i + shift][j] *= 2
        ...
        for i in range(5):
            for j in range(5):
                ...
                if shift > 0:
                    ...
                    board[i][4 - j] = 0
                if 5 - j + shift <= 4:
                    if board[i][5 - j + shift] == board[i][4 - j + shift] and not merged[i][5 - j + shift] and not merged[i][4 - j + shift]:
                        board[i][5 - j + shift] *= 2
